CREATE DATABASE  IF NOT EXISTS `eduardo_shop` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `eduardo_shop`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: eduardo_shop
-- ------------------------------------------------------
...
--
-- Dumping events for database 'eduardo_shop'
--

--
-- Dumping routines for database 'eduardo_shop'
--
